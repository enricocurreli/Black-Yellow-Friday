        ...
        <div className="flex-none">
          <ul className="menu menu-horizontal px-3 gap-3">
            <li className="text-2xl font-bold ">
              <a className="btn-ghost hover:bg-[#FDED00] hover:text-black">
                Products
              </a>
            </li>
            {!auth?.user ? (
              ...
              <Link
                ...
                className="rounded-md px-3 py-2  ring-1 ring-transparent transition hover:text-black/70 focus:outline-none  text-white  text-2xl font-bold   btn-ghost hover:bg-[#FDED00] hover:text-black"
              >
                Dashboard
              </Link>
            )}
